$(document).ready(function () { // when the html is loaded run the code in document readys function
    ...
    // var queryURL = "https://youtube.googleapis.com/youtube/v3/search?part=snippetqueen&maxResults=1&q=&key=" + APIKey //im going to use this query url to ask the youtube api for a response
